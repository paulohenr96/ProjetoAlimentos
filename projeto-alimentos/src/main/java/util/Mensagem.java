...
public class Mensagem implements Serializable{
	...
	public static final String MENSAGEM_SENHA="Insira a senha correta.";
	public static final String MENSAGEM_CONFIRMA_SENHA="Erro ao confirmar a senha.";

	public static final String MENSAGEM_USUARIO_EXISTENTE="Já existe um usuário com este login.";
